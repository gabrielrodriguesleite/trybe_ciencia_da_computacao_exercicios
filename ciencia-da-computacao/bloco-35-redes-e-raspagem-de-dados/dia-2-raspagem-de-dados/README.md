...
> ⚠️ Importe o arquivo [books.json](https://assets.app.betrybe.com/computer-science/python/entrada-saida/books-346aab4788ea58d4c3aa988632da100b.json) no MongoDB antes de responder as próximas questões.
...
```
> ⚠️ Faça requisições para as URLs das imagens e escreva seus conteúdos em arquivos binários. São 206 no total.
```
