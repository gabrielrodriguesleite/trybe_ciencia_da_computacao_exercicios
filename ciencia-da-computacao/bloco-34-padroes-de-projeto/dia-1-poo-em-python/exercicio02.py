class Estatistica:
    ...
    def mediana(self, lista):
        ...
        Returns:
            número: O valor central de um conjunto ordenado ou a média dos \
                2 valores centrais
        """
        lista.sort()
        if len(lista) % 2 == 0:
    ...
    def moda(self, lista):
        ...
        Returns:
            número: O número que aparece com mais frequência em um conjunto \
                de dados
        """
        lista.sort()
        m = {}
...
def test_estatistica_moda():
    ...
    assert Estatistica().moda(
        [155, 13, 22, 33, 35, 35, 34, 4, 446, 56, 56, 35]) == 35
